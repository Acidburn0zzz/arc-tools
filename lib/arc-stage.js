...
class ArcStage {
  ...
  _pullLatest() {
    ...
    return this._exec(`git pull origin master`, this.dir)
    .then(() => this._exec(`git pull origin stage`, this.dir))
    .then(() => this._exec(`git checkout master`, this.dir));
  }
